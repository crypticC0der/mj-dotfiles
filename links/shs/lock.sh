...
i3lock -c 000000ff -S 1 --pass-media-keys --bar-indicator --bar-pos 1040 --bar-direction 1 -i ~/Documents/lock2.png \
		--greeter-font=hack --greeter-text="Oh hell no." --greeter-color=bd1864 --greeter-size=100 --greeter-pos="2425:720" \
